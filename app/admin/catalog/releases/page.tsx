        ...
        actions={
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => router.push("/admin/catalog/create/single")}>Single</DropdownMenuItem>
              <DropdownMenuItem onClick={() => router.push("/admin/catalog/create/ep")}>EP</DropdownMenuItem>
              <DropdownMenuItem onClick={() => router.push("/admin/catalog/create/album")}>Album</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        }
      />
