...
// vertical time-grid as the desktop week, filling the height (no page scroll).
export default function DayView({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
        ...
        {days.map((d) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center rounded-lg py-1 transition-colors ${active ? "bg-white/10" : "hover:bg-white/5"}`}
            >
      ...
      {/* Single-day grid, filling the remaining height */}
      <div className="grid min-h-0 flex-1 overflow-hidden rounded-xl border border-white/10 bg-white/[0.015]" style={{ gridTemplateColumns: `52px 1fr` }}>
        ...
        <div className={`relative h-full border-l border-white/10 ${day.isToday ? "bg-emerald-500/[0.04]" : ""}`}>
